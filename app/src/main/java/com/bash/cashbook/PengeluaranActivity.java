...
public class PengeluaranActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        editDate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                DatePickerDialog datePickerDialog = new DatePickerDialog(
                        PengeluaranActivity.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
        ...
        backToMenu.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent loginIntent = new Intent(PengeluaranActivity.this,MainActivity.class);
            ...
            public void onClick(View view) {
                ...
                if(strDate != "" && strNominal != "" && strKeterangan != ""){
                    ...
                    if(addPengeluaran == true){
                        ...
                        Intent refreshPage = new Intent(PengeluaranActivity.this, PengeluaranActivity.class);
