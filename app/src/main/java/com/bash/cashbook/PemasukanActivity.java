...
public class PemasukanActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        editDate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                DatePickerDialog datePickerDialog = new DatePickerDialog(
                        PemasukanActivity.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
        ...
        backToMenu.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent loginIntent = new Intent(PemasukanActivity.this,MainActivity.class);
            ...
            public void onClick(View view) {
                ...
                if(strDate != "" && strNominal != "" && strKeterangan != ""){
                    ...
                    if(addPemasukan == true){
                        ...
                        Intent refreshPage = new Intent(PemasukanActivity.this, PemasukanActivity.class);
